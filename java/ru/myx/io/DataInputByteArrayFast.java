...
/**
 * Super fast, reusable but doesn't hold and extra buffers and fields, in any
 * case faster than ByteArrayInputStream and DataInputStream.
 * 
 * @author myx
 * 
 */
public final class DataInputByteArrayFast extends InputStream implements DataInput {
	 ...
	 *            the data to read.
	 */
	public DataInputByteArrayFast(final byte[] buffer) {
		this.buffer = buffer;
	 ...
	 */
	public DataInputByteArrayFast(final byte[] buffer, final int offset, final int length) {
		this.buffer = buffer;
		this.pos = offset;
