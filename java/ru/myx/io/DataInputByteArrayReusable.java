...
/**
 * Super fast, expensive, contains 16k buffer for UTF conversions, in any case
 * faster than ByteArrayInputStream and DataInputStream.
 * 
...
public final class DataInputByteArrayReusable extends InputStream implements DataInput {
	...
	private final char[]		chararr		= new char[DataInputByteArrayReusable.BUFFER_UTF];
	...
	public final String readUTF() throws IOException {
		...
		final char[] chararr;
		if (utflen <= DataInputByteArrayReusable.BUFFER_UTF) {
